...
export function getCommentsByPost(http: HttpClient, rootUrl: string, params: GetCommentsByPost$Params, context?: HttpContext): Observable<StrictHttpResponse<PagedModelCommentResponse>> {
...
getCommentsByPost.PATH = '/api/v1/comments/post/{postId}';
