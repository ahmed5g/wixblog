...
export function likePost(http: HttpClient, rootUrl: string, params: LikePost$Params, context?: HttpContext): Observable<StrictHttpResponse<LikeDto>> {
...
likePost.PATH = '/api/posts/{postId}/likes';
